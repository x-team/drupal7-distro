...
<!--<script>
    ...
    var adSsid = 'idol_bts_site_chats';

    ad_script = '<script src="http://FDM_AI.v.fwmrm.net/ad/g/1?nw=116457&amp;pvrn=' + ad_rnum + '&amp;csid='+adSsid.siteSection+'&amp;resp=ad;;ptgt=s&amp;envp=g_js&amp;slid={{ type }}&amp;w={{ ad_width }}&amp;h={{ ad_height }}"></scr' + 'ipt>';
    //document.getElementById('{{ type }}').innerHTML = ad_script;
    document.write(ad_script);
</script>
<noscript>
    <iframe src="http://FDM_AI.v.fwmrm.net/ad/g/1?nw=116457&amp;pvrn=123456789&amp;csid={{ adCsid.default }}&amp;resp=ad;;ptgt=s&amp;envp=g_iframe&amp;slid={{ type }}&amp;w={{ ad_width }}&amp;h={{ ad_height }}" width="{{ ad_width }}" height="{{ ad_height }}" border="0" marginwidth="0" marginheight="0" frameborder="0" scrolling="no"></iframe>
</noscript>-->
